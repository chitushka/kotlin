...
class KotlinDaemonIT : BaseGradleIT() {
    ...
    @Test
    fun `Gradle build classpath should not be leaked into daemon classpath`() {
    ...
    @Test
    fun `Gradle build classpath should not be leaked into daemon classpath on using custom compiler jar`() {
