...
fun main() {
    val baseDir1 = File("/Users/Dmitriy.Dolovov/temp/commonizer-output.502") // original
    val baseDir2 = File("/Users/Dmitriy.Dolovov/temp/commonizer-output.503") // modified
